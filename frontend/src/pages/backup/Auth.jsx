    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-md mx-auto px-4">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <input className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white" placeholder="Password" type="password" value={password} onChange={e=>setPassword(e.target.value)} required />

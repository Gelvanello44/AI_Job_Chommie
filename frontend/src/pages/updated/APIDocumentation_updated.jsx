...
const APIDocumentation = () => {
  return (
    <PageWrapper
      ...
      subtitle="Integrate with our platform"
    ...
    >
      ...
      >
        <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-8 border border-gray-800">
          {/* Existing APIDocumentation content goes here */}
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">Integrate with our platform</p>
          </div>
        </div>
      </motion.div>
    </PageWrapper>
